...
export const ReferenceDataApp = () =>
{
    ...
    ([
        ...
        },
        {
            ...
            field: 'timezone',
            width: 160,
            headerTooltip: 'Exchange timezone',
            sortable: true,
            filter: true,
        },
        {
            ...
            field: 'openTime',
            width: 90,
            headerTooltip: 'Market open time',
            sortable: true,
            filter: true,
        },
        {
            ...
            field: 'closeTime',
            width: 90,
            headerTooltip: 'Market close time',
            sortable: true,
            filter: true,
        },
        {
            ...
            field: 'lunchStart',
            width: 110,
            headerTooltip: 'Lunch break start time',
            sortable: true,
            filter: true,
        },
        {
            ...
            field: 'lunchEnd',
            width: 110,
            headerTooltip: 'Lunch break end time',
            sortable: true,
            filter: true,
        },
        {
