...
export const ChildOrdersApp = () =>
{
    ...
    useEffect(() =>
    {
        const webWorker = new Worker(new URL("../workers/child-order-reader.js", import.meta.url));
    ...
    useEffect(() =>
    {
        const webWorker = new Worker(new URL("../workers/manage-child-order.js", import.meta.url));
