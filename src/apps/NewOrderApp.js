...
export const NewOrderApp = () =>
{
    ...
    ({
        ...
        orderId: '',
        parentOrderId: '',
        percentageOfParentOrder: 0.0,
        orderNotionalValueInUSD: 0.0,
        orderNotionalValueInLocal: 0.0,
        residualNotionalValueInLocal: 0.0,
        residualNotionalValueInUSD: 0.0,
        executedNotionalValueInUSD: 0.0,
        executedNotionalValueInLocal: 0.0,
        arrivalPrice: 0.0,
        traderInstruction: '',
        qualifier: 'C:2',
        destination: 'DMA',
