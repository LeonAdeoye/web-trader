...
export const AlertConfigurationsDialogStageOneComponent = ({handleInputChange}) =>
{
    ...
    return (
        <div className={"alert-config-stage-one"}>
            <div className="alert-configurations-name">
                <TextField size='small' label='Enter the name of the new alert...' value={alertConfiguration.alertName}
                       onChange={(e) => handleInputChange('alertName', e.target.value)} margin='normal'/>
            </div>
            <div className="alert-configurations-client">
                <Autocomplete renderInput={(params) => <TextField {...params} label='Select the client' />}
                      value={alertConfiguration.clientName || null} size='small' required
            ...
            <div className="alert-configurations-desk">
                <TextField size='small' label='Select the desk' select value={alertConfiguration.desk}
            ...
            <div className="alert-configurations-side">
                <TextField size='small' label='Select the side' select value={alertConfiguration.side}
            ...
            <div className="alert-configurations-market">
                <TextField size='small' label='Select the market' select value={alertConfiguration.market}
            ...
            <div className="alert-configurations-priority">
                <TextField size='small' label='Select the priority' select value={alertConfiguration.priority}
