...
const tooltipStyles = {
    tooltip: { sx: { backgroundColor: '#404040', color: '#ffffff', fontSize: '0.95rem', lineHeight: 1.6, maxWidth: 420, whiteSpace: 'pre-line', padding: '10px 14px', fontWeight: 400, border: '1px solid #6b6b6b', borderRadius: '4px', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.35)' } },
